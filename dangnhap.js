...
//     let passValue = userPass.value;
//     if (emailValue == '' && passValue == '') {
//         errorEmail.innerText = 'Điền đầy đủ email'
//         errorPass.innerText = 'Điền đầy đủ mật khẩu'
...
//         if (emailValue == localStorage.getItem() && passValue != account.pass) {
//             errorEmail.innerText = ''
//             errorPass.innerText = 'Sai mật khẩu'
//         } else if (emailValue != account.user && passValue == account.pass) {
//             errorEmail.innerText = 'Sai email'
//             errorPass.innerText = ''
//         } else if (emailValue != account.user && passValue != account.pass) {
//             errorEmail.innerText = 'Sai email'
//             errorPass.innerText = 'Sai mật khẩu'
